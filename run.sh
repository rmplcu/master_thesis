...
#Map server
gnome-terminal --tab -- rosrun map_server map_server ./workspace/maps/map.yaml

#Navigation stack
gnome-terminal --tab -- roslaunch husky_navigation amcl_demo.launch map_file:=./workspace/maps/map.yaml
